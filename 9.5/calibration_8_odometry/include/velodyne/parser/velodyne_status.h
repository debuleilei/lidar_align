...
#ifndef ONBOARD_DRIVERS_VELODYNE_INCLUDE_VELODYNE_PARSER_VELODYNE_STATUS_H
#define ONBOARD_DRIVERS_VELODYNE_INCLUDE_VELODYNE_PARSER_VELODYNE_STATUS_H
...
//get velodyne status from packet by Velodyne Manual
class VelodyneStatus {

public:
    VelodyneStatus();
    ~VelodyneStatus() {}
    void get_status(const std::shared_ptr<adu::common::sensor::VelodyneScan const>& scan);
