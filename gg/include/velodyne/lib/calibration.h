...
#ifndef CYBERTRON_ONBOARD_DRIVERS_VELODYNE_INCLUDE_VELODYNE_LIB_CALIBRATION_H
#define CYBERTRON_ONBOARD_DRIVERS_VELODYNE_INCLUDE_VELODYNE_LIB_CALIBRATION_H
...
#endif  // CYBERTRON_ONBOARD_DRIVERS_VELODYNE_INCLUDE_VELODYNE_LIB_CALIBRATION_H
