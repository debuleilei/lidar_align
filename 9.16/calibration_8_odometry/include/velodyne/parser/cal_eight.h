...
public:
  ...
  vector<Eigen::Affine3d> deta_trans;
...
private:
    ...
    void convert(pcl::PointCloud<pcl::PointXYZRGB>& in, PointMatcher<float>::DataPoints& out);
...
public:
	...
	void estimate(pcl::PointCloud<pcl::PointXYZ>& ref,
				  ...
				  Eigen::Affine3d& t);
    void estimate(pcl::PointCloud<pcl::PointXYZRGB>& ref,
