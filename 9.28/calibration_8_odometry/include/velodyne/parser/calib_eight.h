...
class Calibrate_eight {
 ...
 public:
  ...
  bool velodyne_fusion(const std::shared_ptr<adu::common::sensor::PointCloud const>& point_cloud_left,
                  const std::shared_ptr<adu::common::sensor::PointCloud const>& point_cloud_right,                 
                  std::shared_ptr<adu::common::sensor::PointCloud>& point_cloud_fusion);
  bool transform_lidar(const std::shared_ptr<adu::common::sensor::PointCloud const>& point_cloud_first,                                   
                  std::shared_ptr<adu::common::sensor::PointCloud>& point_cloud_fusion,
                  const Eigen::Affine3d& lidar_extrinsic_);

  bool transform_lidar_regist(const std::shared_ptr<adu::common::sensor::PointCloud const>& point_cloud_first,
                  const std::shared_ptr<adu::common::sensor::PointCloud const>& point_cloud_second,                                  
                  std::shared_ptr<adu::common::sensor::PointCloud>& point_cloud_fusion,
