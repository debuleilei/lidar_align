...
class Aligner {
 public:
  struct Config {
    ...
    std::string output_pointcloud_path = "/home/caros/baidu/adu/microcar/build/install/fusion.ply";
    std::string output_calibration_path = "/home/caros/baidu/adu/microcar/build/install/fusion.result";
  };
  ...
  void lidarOdomTransform_(Lidar* lidar, Odom* odom);
